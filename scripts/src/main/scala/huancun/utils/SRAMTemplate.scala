...
class TS5N28HPCPLVTA256X8M2F extends ExtModule with HasExtModuleResource {
  ...
  //  })
  addResource("/TS5N28HPCPLVTA256X8M2F.v")
}

class TS5N28HPCPLVTA256X64M2F extends ExtModule with HasExtModuleResource {
  //  val io = IO(new Bundle {
  ...
  //  })
  addResource("/TS5N28HPCPLVTA256X64M2F.v")
}

class TS5N28HPCPLVTA256X32M2F extends ExtModule with HasExtModuleResource {
  //  val io = IO(new Bundle {
...
(
  ...
  val sram = Seq.fill(way)(Module(new TS5N28HPCPLVTA256X64M2F()))
  ...
  println("Out of Core Sram Width: %d, Set: %d, Way: %d, singlePort: %d\n", gen.getWidth.W, set, way, singlePort)
}
...
(
  ...
  println("ReplaceSram Width: %d, Set: %d, Way: %d, singlePort: %d\n", gen.getWidth.W, set, way, singlePort)
}
...
(
  ...
  println("EccSram Width: %d, Set: %d, Way: %d, singlePort: %d\n", gen.getWidth.W, set, way, singlePort)
}
...
(
  ...
  val wordType = UInt(gen.getWidth.W)
  //val array = SyncReadMem(set, Vec(way, wordType))
  val sram = Seq.fill(way)(Module(new TS5N28HPCPLVTA256X32M2F()))
  val (resetState, resetSet) = (WireInit(false.B), WireInit(0.U))
  ...
  println("TagSram Width: %d, Set: %d, Way: %d, singlePort: %d\n", gen.getWidth.W, set, way, singlePort)
}
...
(
  ...
  println("MetaSram Width: %d, Set: %d, Way: %d, singlePort: %d\n", gen.getWidth.W, set, way, singlePort)
}
...
(
  ...
  println("RRTableSram Width: %d, Set: %d, Way: %d, singlePort: %d\n", gen.getWidth.W, set, way, singlePort)
}
